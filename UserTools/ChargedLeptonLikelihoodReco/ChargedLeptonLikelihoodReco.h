...
private:
    ...
    /**/ string       m_hists_transmission_mu_tankWater_path        ;
    /**/ string       m_hists_transmission_e_tankWater_path         ;
    /**/ string       m_hists_transmission_mu_MRDsci_path           ;
    /**/ string       m_hists_transmission_e_MRDsci_path            ;
    /**/ string       m_hists_transmission_mu_tankWater_name        ;
    /**/ string       m_hists_transmission_e_tankWater_name         ;
    /**/ string       m_hists_transmission_mu_MRDsci_name           ;
    /**/ string       m_hists_transmission_e_MRDsci_name            ;
    /**/ unsigned int m_hists_transmission_mu_tankWater_energy_min  ;
    /**/ unsigned int m_hists_transmission_e_tankWater_energy_min   ;
    /**/ unsigned int m_hists_transmission_mu_MRDsci_energy_min     ;
    /**/ unsigned int m_hists_transmission_e_MRDsci_energy_min      ;
    /**/ unsigned int m_hists_transmission_mu_tankWater_energy_delta;
    /**/ unsigned int m_hists_transmission_e_tankWater_energy_delta ;
    /**/ unsigned int m_hists_transmission_mu_MRDsci_energy_delta   ;
    /**/ unsigned int m_hists_transmission_e_MRDsci_energy_delta    ;
    /**/ unsigned int m_hists_transmission_mu_tankWater_num         ;
    /**/ unsigned int m_hists_transmission_e_tankWater_num          ;
    /**/ unsigned int m_hists_transmission_mu_MRDsci_num            ;
    /**/ unsigned int m_hists_transmission_e_MRDsci_num             ;
    /**/
